...
{
   public class ReportComparableUserResult : ITemplateExcel<ComparableUserResult[]>
    {
        ...
        public void CreateDocument(string path, ComparableUserResult[] template, object obj = null)
        {
        ...
        public void CreateExcel(SpreadsheetDocument document, ComparableUserResult[] template, object obj = null)
        {
            ...
            list1.Worksheet = reportExcelUsers.ReportModelComparableUser(template, (Parametrs[])obj);
