...
namespace LibaryDocumentGenerator.ProgrammView.FullDocument
{
   public class DocumentsFull
    ...
    "0", "0", TableVerticalAlignmentValues.Center, CellBorders.GenerateBorderFull()));
            ...
            {
                cellCollection.Add(CellGenerate.GenerateCell(paragraphGenerate.RunParagraphGeneratorStandart(bodyTable.NameUser, "20", JustificationValues.Center), "0", TableWidthUnitValues.Auto, "0", "0", TableVerticalAlignmentValues.Center, CellBorders.GenerateBorderFull()));
                ...
                if (telephoneHelp.TelephonBody.Length > 0)
                {
                 try
                 {
                     foreach (var telephoneBody in telephoneHelp.TelephonBody)
                     {
                         ...
                         {
                             var strName = users.NameUser.Split(' ');
        ...
        table1.Append(rows.GenerateRow(ref cellCollection, true, rows.FormulHeightRow(0.8)));
                ...
                foreach (var user in templateotdel.Users)
                {
                    cellCollection.Add(CellGenerate.GenerateCell(
                        ...
                        CellBorders.GenerateBorderFull()));
                    cellCollection.Add(CellGenerate.GenerateCell(
                        paragraphGenerate.RunParagraphGeneratorStandart(user.NameUser, "16"), "0",
        ...
        public Body CreateDocMemoReport(ModelMemoReport template)
        {
            ...
            cellCollection.Add(CellGenerate.GenerateCell(paragraphGenerate.RunParagraphGeneratorStandart(template.UserDepartment.NameUser,"20",JustificationValues.Center), CellGenerate.FormulWidthCell(2.94),
                TableWidthUnitValues.Dxa, "0", "0", TableVerticalAlignmentValues.Center, CellBorders.GenerateBorderFull()));
        ...
        public Body CreateDocMemoApplication(ModelMemoReport template)
        {
            ...
            cellCollection.Add(CellGenerate.GenerateCell(paragraphGenerate.RunParagraphGeneratorStandart("Фамилия, имя, отчество/учетная запись сотрудника", "16",JustificationValues.Center), CellGenerate.FormulWidthCell(3.20), TableWidthUnitValues.Dxa, "100", "100", TableVerticalAlignmentValues.Center, CellBorders.GenerateBorderFull()));
            cellCollection.Add(CellGenerate.GenerateCell(paragraphGenerate.RunParagraphGeneratorStandart("Должность", "16", JustificationValues.Center), CellGenerate.FormulWidthCell(2.75), TableWidthUnitValues.Dxa, "100", "100", TableVerticalAlignmentValues.Center, CellBorders.GenerateBorderFull()));
            cellCollection.Add(CellGenerate.GenerateCell(paragraphGenerate.RunParagraphGeneratorStandart("Обоснование необходимости проведения указанного вида работ в соответствии с должностными обязанностями сотрудника (ссылка на раздел должностного регламента или иной нормативный документ)", "16", JustificationValues.Center), CellGenerate.FormulWidthCell(6.75), TableWidthUnitValues.Dxa, "100", "100", TableVerticalAlignmentValues.Center, CellBorders.GenerateBorderFull()));
            cellCollection.Add(CellGenerate.GenerateCell(paragraphGenerate.RunParagraphGeneratorStandart("Телефон/комната", "16", JustificationValues.Center), CellGenerate.FormulWidthCell(1.48), TableWidthUnitValues.Dxa, "100", "100", TableVerticalAlignmentValues.Center, CellBorders.GenerateBorderFull()));
            cellCollection.Add(CellGenerate.GenerateCell(paragraphGenerate.RunParagraphGeneratorStandart("Ресурс (согласно Перечню)", "16", JustificationValues.Center), CellGenerate.FormulWidthCell(3.01), TableWidthUnitValues.Dxa, "100", "100", TableVerticalAlignmentValues.Center, CellBorders.GenerateBorderFull()));
            ...
            cellCollection.Add(CellGenerate.GenerateCell(paragraphGenerate.RunParagraphGeneratorStandart("IP-адрес рабочей станции", "16", JustificationValues.Center), CellGenerate.FormulWidthCell(2.50), TableWidthUnitValues.Dxa, "100", "100", TableVerticalAlignmentValues.Center, CellBorders.GenerateBorderFull()));
            ...
            cellCollection.Add(CellGenerate.GenerateCell(paragraphGenerate.RunParagraphGeneratorStandart("Примечание", "16", JustificationValues.Center), CellGenerate.FormulWidthCell(2.01), TableWidthUnitValues.Dxa, "100", "100", TableVerticalAlignmentValues.Center, CellBorders.GenerateBorderFull()));
            table2.Append(rows.GenerateRow(ref cellCollection));
            ...
            cellCollection.Add(CellGenerate.GenerateCell(paragraphGenerate.RunParagraphGeneratorStandart("2", "16", JustificationValues.Center), CellGenerate.FormulWidthCell(3.20), TableWidthUnitValues.Dxa, "100", "100", TableVerticalAlignmentValues.Center, CellBorders.GenerateBorderFull()));
            cellCollection.Add(CellGenerate.GenerateCell(paragraphGenerate.RunParagraphGeneratorStandart("3", "16", JustificationValues.Center), CellGenerate.FormulWidthCell(2.75), TableWidthUnitValues.Dxa, "100", "100", TableVerticalAlignmentValues.Center, CellBorders.GenerateBorderFull()));
            cellCollection.Add(CellGenerate.GenerateCell(paragraphGenerate.RunParagraphGeneratorStandart("4", "16", JustificationValues.Center), CellGenerate.FormulWidthCell(6.75), TableWidthUnitValues.Dxa, "100", "100", TableVerticalAlignmentValues.Center, CellBorders.GenerateBorderFull()));
            cellCollection.Add(CellGenerate.GenerateCell(paragraphGenerate.RunParagraphGeneratorStandart("5", "16", JustificationValues.Center), CellGenerate.FormulWidthCell(1.48), TableWidthUnitValues.Dxa, "100", "100", TableVerticalAlignmentValues.Center, CellBorders.GenerateBorderFull()));
            cellCollection.Add(CellGenerate.GenerateCell(paragraphGenerate.RunParagraphGeneratorStandart("6", "16", JustificationValues.Center), CellGenerate.FormulWidthCell(3.01), TableWidthUnitValues.Dxa, "100", "100", TableVerticalAlignmentValues.Center, CellBorders.GenerateBorderFull()));
            ...
            cellCollection.Add(CellGenerate.GenerateCell(paragraphGenerate.RunParagraphGeneratorStandart("8", "16", JustificationValues.Center), CellGenerate.FormulWidthCell(2.50), TableWidthUnitValues.Dxa, "100", "100", TableVerticalAlignmentValues.Center, CellBorders.GenerateBorderFull()));
