...
namespace LibaryDocumentGeneratorTestsTemplate.SoapBynary
{
    ...
    public class WcfBinaryCodec
    {
        ...
        /// <returns></returns>
        public void DecodeBinaryXML(Stream binaryInput, Stream xmlOutput,
            bool? explodeNewlines)
        {
            // defaults
            ...
            using (var binaryReader =
                XmlDictionaryReader.CreateBinaryReader(binaryInput,
                    WcfDictionaryBuilder.Dict, XmlDictionaryReaderQuotas.Max))
            {
