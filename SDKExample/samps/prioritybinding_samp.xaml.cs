...
namespace myPriorityBinding //требуется сопоставить страницу XAML
{
  ...
  public class AsyncDataProvider
  {
    ...
    public string SlowerDP
    {
      get
      {
        // Это имитирует длительное время до того как
        // данные, к которым осуществляется привязка, станут фактически доступны.
        Thread.Sleep(3000);
        return _slowerDP;
      }
      set { _slowerDP = value; }
